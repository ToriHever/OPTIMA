...
export class RemontKompyuterov implements OnInit {
  ...
  faqItems: FaqItem[] = [
    ...
    { question: 'Выезжает ли мастер на дом?', answer: 'Да, выезжаем по Ростову-на-Дону для ремонта компьютеров, мониторов и принтеров. Ноутбуки и планшеты удобнее принести в сервис.' },
  ...
  ngOnInit(): void {
    ...
    this.meta.updateTag({
      name: 'description',
      content: 'Ремонт ноутбуков, планшетов, компьютеров, мониторов в Ростове-на-Дону. Диагностика бесплатно, гарантия до 90 дней. Сервисный центр Optima.'
    });
  }
}
